...
function DashboardContent() {
  ...
  <div className="glass-card glass-panel px-6 py-4 text-sm text-slate-200 shadow-lg min-w-[200px]" aria-label="Account details">
    <div className="animate-fade-in-up delay-200">
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-8">
          <section className="glass-card glass-panel p-8 shadow-2xl border border-indigo-500/30" aria-labelledby="download-title">
            <div className="animate-fade-in-up">
              <div className="flex items-center justify-between mb-4">
                <h2 id="download-title" className="text-2xl font-bold text-white flex items-center gap-3">
              ...
              <div className="flex flex-col gap-3">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-3 rounded-lg btn-primary py-4 text-lg font-bold shadow-lg hover:shadow-xl transition-all"
